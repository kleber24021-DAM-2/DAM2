...
abstract class RVPseudoPaginator(recyclerView: RecyclerView) : RecyclerView.OnScrollListener() {

    //Esta clase la he copiado, casi literalmente de alguien que hizo la paginacion, sin utilizar la biblioteca de paginacion
